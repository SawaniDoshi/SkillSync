...
const LandingPage = () => {
  ...
  return (
    <>
      <div class="relative bg-purple-50 text-gray-900">
        <header id="header" class="text-slate-700 container relative mx-auto flex flex-col overflow-hidden px-4 py-4 lg:flex-row lg:items-center">
          ...
          >
            <ul class="flex w-full flex-col items-center space-y-2 lg:flex-row lg:justify-center lg:space-y-0">
              ...
              <li class="lg:mr-12">
  <a href="#contact" class="rounded text-gray-700 transition focus:outline-none focus:ring-1 focus:ring-blue-700 focus:ring-offset-2">
    Contact
  </a>
</li>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    ...
    {/* First row with two contacts */}
    <div class="grid gap-8 mb-4 lg:mb-8 md:grid-cols-2">
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex">
        <a href="#">
          <img
            class="w-62 h-60 rounded-lg sm:rounded-none sm:rounded-l-lg"
            src="src\assets\men1.jpeg"
            alt="Bonnie Avatar"
          />
        </a>
        <div class="p-5">
          ...
          <p class="mt-3 mb-4 font-light text-gray-500">
            Alex is a creative problem solver with a passion for building scalable web applications.
          </p>
      ...
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex">
        ...
        <div class="p-5">
          ...
          <p class="mt-3 mb-4 font-light text-gray-500">
            Nick specializes in machine learning and data analysis, turning data into actionable insights.
          </p>
          <ul class="flex space-x-4 sm:mt-0">
            <li>
                    <a href="https://www.linkedin.com/in/chinmay-ankolekar-334177229/" class="text-gray-500 hover:text-gray-900 ">
    ...
    <div class="flex justify-center mt-4">
      <div class="bg-gray-50 rounded-lg shadow sm:flex max-w-2xl">
        ...
        <div class="p-5">
          ...
          <span class="text-gray-500">UI/UX Engineer</span>
          <p class="mt-3 mb-4 font-light text-gray-500">
            Jordan is passionate about crafting intuitive and visually appealing user experiences.
          </p>
          <ul class="flex space-x-4 sm:mt-0">
          <li>
                    <a href="https://www.linkedin.com/in/chinmay-ankolekar-334177229/" class="text-gray-500 hover:text-gray-900 ">
      ...
      <div>
  <footer class="w-full py-4 bg-purple-800 mt-8 relative">
    <div class="text-center text-white">
      © SkillSync 2025, All rights reserved.
    </div>
    {/* Arrow to go back to the top */}
    <a
      href="#header"
      class="absolute right-4 bottom-4 bg-white text-purple-800 p-2 rounded-full shadow-lg hover:bg-purple-700 hover:text-white transition"
      title="Go to top"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
